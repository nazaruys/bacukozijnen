...
export default function Home() {
  return (
    <div className="bg-background font-outfit">
      ...
      {/* Main */}
      <section
        className="relative flex flex-col md:h-[600px] px-4 py-10 md:px-36 md:py-20 gap-6"
        id="main"
        style={{
      ...
      >
        {/* Desktop row layout */}
        <div className="flex flex-col md:flex-row justify-between h-full w-full gap-6">
          {/* Main container */}
          ...
          {/* Spacer on desktop to reserve space */}
          <div className="hidden md:block w-[465px]" />
        </div>
      ...
      {/* Welcome */}
      <section className="h-auto md:h-[750px] bg-secondaryBackground px-6 py-12 md:px-36 md:py-[100px] flex flex-col md:flex-row items-center">
        {/* Desktop image only */}
        <img 
          src="/images/sofa.webp" 
          alt="Zonlicht valt op een moderne bank via grote kozijnen in de woonkamer"
          className="hidden md:block w-[400px] h-auto md:mr-[130px]"
        />
        ...
        <div className="h-full">
          ...
          <p className="text-secondary text-lg">
            Als je op zoek bent naar nieuwe kozijnen of rolluiken, heb je vast al gemerkt: het aanbod is enorm. Maar waar vind je nu écht kwaliteit, service én eerlijke communicatie onder één dak?<br /><br />
            Juist – bij BaCu Kozijnen.<br /><br />
            ...
            Onze klanten weten: bij BaCu krijg je niet alleen een product, je krijgt een partner die met je meedenkt. Transparant, betrouwbaar en altijd gericht op het beste resultaat.<br /><br />
            Je hebt de juiste keuze gemaakt. Welkom bij BaCu – waar kwaliteit en service samenkomen.
          </p>
        </div>
      </section>
      {/* Products */}
      <section className="bg-background px-5 md:px-36 py-16 md:py-20">
        ...
        <div className="flex flex-col md:flex-row flex-wrap gap-10 justify-between items-center">
          ...
          {[
            {
              href: "/kozijnen",
              img: "/images/kozijn.webp",
              alt: "Kunststof kozijn op een woning, strak en onderhoudsvriendelijk",
              title: "Kozijnen",
              description: "Isolatie, minder geluid en een stijlvolle uitstraling – haal meer uit je kozijnen.",
              cta: "Stel je kozijnen samen",
              pros: [
                "Bespaar op je energierekening",
                "Verminder geluidsoverlast",
                "Verhoog je woningwaarde",
              ],
            },
            {
              href: "/buitendeuren",
              img: "/images/voordeur.webp",
              alt: "Stijlvolle rode voordeur met glas en metalen handgreep",
              title: "Buitendeuren",
              description: "Je buitendeur verwelkomt gasten en houdt kou en indringers buiten.",
              cta: "Stel je buitendeur samen",
              pros: [
                "Verbeter de uitstraling",
            ...
            {
              href: "/rolluiken",
              img: "/images/rolluiken.webp",
              alt: "Zwarte rolluiken gemonteerd op witte gevel van een vrijstaand huis",
              title: "Rolluiken",
              description: "Meer privacy, zonbescherming en veiligheid – kies voor rolluiken.",
              cta: "Stel je rolluiken samen",
              pros: [
                "Verhoog je privacy",
                "Geniet van geluidsisolatie",
                "Verklein de kans op inbraken",
              ],
            },
          ].map((product, i) => (
            <a
              key={i}
              href={product.href}
              aria-label={`Ontdek ${product.title.toLowerCase()}`}
              className="w-full max-w-[375px] h-[625px] shadow-lg flex flex-col overflow-hidden group"
            >
              ...
              <div className="p-7 flex flex-col flex-grow">
                ...
                <p className="text-secondary text-[17px] mt-2">{product.description}</p>

                {/* List of pros */}
                <div className="py-7 flex flex-col gap-2">
                  {product.pros.map((pro, index) => (
                    <div key={index} className="flex items-center gap-3">
                      <svg xmlns="http://www.w3.org/2000/svg" className="size-5 text-[#41D872]" fill="none" viewBox="0 0 24 24" strokeWidth="3" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 12.75 6 6 9-13.5" />
                      </svg>
                      <span className="text-[15px]">{pro}</span>
                    </div>
                  ))}
                </div>
                ...
                <div className="flex items-center mt-auto">
                  <span className="mr-1 text-lg">{product.cta}</span>
                  <svg xmlns="http://www.w3.org/2000/svg" className="size-5 transition-transform duration-500 transform group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
        ...
        <div className="flex flex-wrap justify-center md:justify-between items-start mt-14 gap-6">
          ...
          <div className="flex flex-col w-full sm:w-[350px] bg-secondaryBackground p-5">
            ...
            <p className="text-secondary text-lg mt-2">
              Transparante offertes zonder verrassingen – topkwaliteit voor een scherpe en eerlijke prijs.
            </p>
          </div>
          ...
          <div className="flex flex-col w-full sm:w-[350px] bg-secondaryBackground p-5">
            ...
            <p className="text-secondary text-lg mt-2">
              Samen zoeken we de beste oplossing voor jouw woning – op maat en passend bij jouw wensen.
            </p>
          </div>
          ...
          <div className="flex flex-col w-full sm:w-[350px] bg-secondaryBackground p-5">
            ...
            <p className="text-secondary text-lg mt-2">
              Deskundige montage voor perfect resultaat – professioneel, nauwkeurig en tot in de puntjes verzorgd.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="px-12 md:px-[250px] flex flex-col md:flex-row items-center justify-between py-24">
        ...
        <img
          ...
          className="hidden md:block w-36 md:w-[500px] h-auto"
        />
      </section>
      {/* Form */}
      <OfferteForm />
