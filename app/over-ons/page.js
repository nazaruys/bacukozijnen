      	...
      	{/* Navbar */}
				...
				<section className="bg-secondaryBackground px-6 md:px-36 flex flex-col-reverse md:flex-row items-center justify-between py-16 md:py-16">
					...
					<img
						...
						className="md:w-[450px] h-auto rounded-xl shadow-lg mb-10 md:mb-0"
					/>
				</section>
				{/* Our goal */}
				<section className="p-6 py-16 bg-background md:px-36 md:py-[100px] flex flex-col md:flex-row items-center">
					<img 
						...
						className="w-36 md:min-w-[500px] max-h-[615px] object-cover md:mr-[130px] rounded-xl hidden md:block"
					/>
					<div className="h-full">
						<h1 className="text-4xl font-semibold mb-8">Ons doel</h1>
				...
				>
					<img
						...
						className="w-full md:w-[620px] h-auto md:ml-24 rounded-xl"
					/>
					<div
