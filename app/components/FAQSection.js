...
function FAQSection({faqItems}) {
  ...
  const getContentHeight = (index) => {
	...
	return (
		<section className="flex flex-col justify-center px-6 md:px-36 py-12 md:py-28">
      <h2 className="text-3xl md:text-4xl text-center md:text-left font-semibold">Veelgestelde vragen</h2>
      <div className="flex flex-col md:flex-row md:gap-x-24 mt-10">
