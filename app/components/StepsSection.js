...
function StepsSection({product}) {
    return (
        <div className="flex flex-row justify-between items-center md:px-36 h-[220px] relative">
            ...
            {/* First step */}
            <div className="rounded-lg w-[290px] h-[130px] md:p-[14px] bg-white z-10 relative" style={{ border: "0.5px solid #717171" }}>
                {/* Circle with "1" */}
                <div className="absolute top-[14px] left-[14px] w-[30px] h-[30px] rounded-full text-base flex items-center justify-center text-lg" style={{ border: "0.5px solid #717171" }}>
                    1
                </div>
                ...
                <p className="absolute bottom-[14px] left-[14px] right-0 text-lg text-gray-700">
                    <a className="underline font-medium" href="#">Stel je {product.toLowerCase()} zelf samen</a> en bereken de prijs.
                </p>
            </div>
